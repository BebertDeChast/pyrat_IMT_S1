...
def naive_tsp(meta_graph, initial_vertex):
    """
    We take a graph with a set of vertices we want to go through. We explore all the possibilities and return the path corresponding.
    Variables :
        meta_graph: dict{tuple(int, int), dict{tuple(int, int), int}}
...
def preprocessing(maze_map, maze_width, maze_height, player_location, opponent_location, pieces_of_cheese, time_allowed):
    ...
    meta_graph, distance_table = build_meta_graph(maze_map, pieces_of_cheese, player_location)
